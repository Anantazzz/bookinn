                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select name="discount_code" id="discount_code" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition appearance-none bg-white">
                                    <option value="">-- Pilih Kode Diskon --</option>
                                    <option value="WELCOME10">WELCOME10 - Welcome Discount (10%)</option>
                                    <option value="WEEKEND20">WEEKEND20 - Weekend Special (20%)</option>
                                    <option value="SAVE50K">SAVE50K - Fixed Discount (Rp 50.000)</option>
                                </select>
                                <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Pilih kode diskon untuk mendapatkan potongan harga</p>
                        </div>
                    </div>
                </div>
